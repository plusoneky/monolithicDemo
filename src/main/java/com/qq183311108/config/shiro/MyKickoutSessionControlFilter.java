...
import com.qq183311108.frimware.controller.FrimwareProtocolController;
...
public class MyKickoutSessionControlFilter extends AccessControlFilter {
	...
	private void ajaxOut(ServletResponse hresponse, ApiResDto resDto) throws IOException {
		try {
