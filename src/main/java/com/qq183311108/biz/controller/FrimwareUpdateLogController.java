...
import com.qq183311108.biz.entity.FrimwareUpdateLog;
import com.qq183311108.biz.service.IFirmwareVersionService;
import com.qq183311108.biz.service.IFrimwareUpdateLogService;
import com.qq183311108.biz.vo.FrimwareInfoExcelVO;
...
public class FrimwareUpdateLogController extends BaseController {
	...
	public JsonResult importFrimwareUpdateLog(@ApiParam(required = true, value = "信息安装文件") MultipartFile logFile) {
		...
		try {
			...
			for (FrimwareInfoExcelVO excelTerminalVO : excelList) {
				...
				oneFrimwareUpdateLog.setUpdateResultReport("未验证");
	...
	public JsonResult addFrimwareUpdateLog(@ApiParam(required = true, value = "设备序列号") String sn,
		...
		frimwareUpdateLog.setUpdateResultReport("未验证");
