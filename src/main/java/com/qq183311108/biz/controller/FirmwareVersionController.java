package com.qq183311108.biz.controller;
...
import com.qq183311108.biz.service.IFirmwareVersionService;
...
import com.qq183311108.sys.service.IUploadFileService;
import com.qq183311108.sys.service.impl.UploadFileServiceImpl.UploadFileType;
import com.qq183311108.sys.vo.FileStoreInfoVO;
...
public class FirmwareVersionController extends BaseController {
	...
	@Autowired
	FirmwareVersionController(IFirmwareVersionService firmwareVersionServiceImpl,
			IUploadFileService uploadFileServiceImpl) {
	...
	@PostMapping(value = { "/addFirmwareVersion" }, produces = { MediaType.APPLICATION_JSON_UTF8_VALUE }, consumes = {
	...
	@ResponseBody
	@ApiOperation(value = "测试上传文件", notes = "上传的文件后面也要限制大小", tags = {
	...
	public JsonResult testUpload(@ApiParam(required = true, value = "test") String test,
		...
		return renderSuccess(
				fileStoreInfoVO.isCanDownLoad() ? fileStoreInfoVO.getDownLoadURL() : fileStoreInfoVO.getAbsPath());
	}
